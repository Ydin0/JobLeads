            ...
            <div className="mx-auto max-w-5xl space-y-16 px-6">
                <div className="grid gap-12 md:grid-cols-5">
                    <div className="space-y-6 md:col-span-2 md:space-y-12">
                        ...
                        <p className="text-muted-foreground text-balance text-sm">Turn job postings into warm leads for your recruitment agency. Scrape, enrich, and push to CRM automatically.</p>
                    </div>
                ...
                <div className="flex flex-wrap justify-between gap-4">
                    <span className="text-muted-foreground text-sm">&copy; {new Date().getFullYear()} RecLead. All rights reserved.</span>
